...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.branch_reason'
        db.add_column(u'tasks_branch', 'branch_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.branch_reason'
        db.delete_column(u'tasks_branch', 'branch_reason')
